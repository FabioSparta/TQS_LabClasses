 ...
 */
public class Dip {
    static final int HIGHEST_NUMBER = 49;
    static final int HIGHEST_STAR = 9;
    static final int QTY_NUMBERS = 5;
    static final int QTY_STARS = 2;
    ...
    public Dip(int[] arrayOfNumbers, int[] arrayOfStarts) {
        ...
        if (QTY_NUMBERS == arrayOfNumbers.length && QTY_STARS == arrayOfStarts.length) {
